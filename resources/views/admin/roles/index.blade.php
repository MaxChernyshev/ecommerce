    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('admin.roles.create') }}" class="btn btn-primary">Create New</a>
            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-borderless rounded-md">
                                    ...
                                    @foreach ($roles as $role)
                                        <tr>
                                            ...
                                            <td>
                                                <button data-bs-target="#deleteRoleModal{{ $role->id }}"
                                                    data-bs-toggle="modal" type="submit" class="btn btn-danger btn-sm">
                                        ...
                                        @push('modals')
                                            <div class="modal fade" tabindex="-1" id="deleteRoleModal{{ $role->id }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('admin.roles.destroy', $role) }}"
                                                                data-turbo-method="delete" class="btn btn-danger">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
