                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.roles.update', $role) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="label form-control-label">Name</label>
                                    ...
                                    <div class="form-group">
                                        <label for="guard" class="label form-control-label">Guard</label>
                                        <input type="text" name="guard" id="guard" placeholder="web"
